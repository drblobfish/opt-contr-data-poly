...
\usetikzlibrary{matrix,chains,positioning,decorations.pathreplacing,arrows,math}
...
\tikzstyle{every edge}=[draw=black!70]
\tikzstyle{neuron}=[circle,fill=black!25,draw=black!75,minimum size=20pt,inner sep=0pt,thick]
\tikzstyle{input neuron}=[neuron,draw={black}, fill={rgb:red,1;white,5}]
\tikzstyle{hidden neuron}=[neuron, draw={black}, fill={rgb:blue,1;white,5}]
\tikzstyle{output neuron}=[neuron,draw={black}, fill={rgb:green,1;white,5}]
\tikzstyle{annot} = [text width=9em, text centered]
\tikzstyle{annot2} = [text width=4em, text centered]
...
\newcommand{\fourth}{4\textsuperscript{th}\xspace}
