...
\begin{document}
	...
	\thm[supporting-hyperplane]{Supporting hyperplane theorem}{
	...
	We have the following extension of Proposition~\ref{prop:convex-cont}, which we will not prove.

	\prop[convex-lsc]{}{
		Let $F:\bbR^d\to \bbR\cup\{+\infty\}$ be an exteded convex function. Then, $F$ is lower semicontinuous.
	}
